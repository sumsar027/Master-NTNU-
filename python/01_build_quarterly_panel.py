...
BALANCE_DIR_CANDIDATES = [
    DATA_RAW / "Balansesheet" / "BalanceSheets",
    DATA_RAW / "Balansesheet",
    DATA_RAW / "BalanceSheet" / "BalanceSheets",
    DATA_RAW / "BalanceSheet",
]

INCOME_DIR_CANDIDATES = [
    DATA_RAW / "Income_statement" / "IncomeStatement",
    DATA_RAW / "Income_statement",
    DATA_RAW / "IncomeStatement" / "IncomeStatement",
    DATA_RAW / "IncomeStatement",
]
