...
def main():
    ...
    ax1.plot(df["period_end_date"], df["var_99"], marker="o", linewidth=2.5, label="Actual VaR 99%")
    ...
    ax2.scatter(df["var_99"], df["predicted_gaussian"], s=70, alpha=0.75)
    ...
    ax3.scatter(df["var_99"], df["predicted_boa"], s=70, alpha=0.75)
    ...
    ax4.hist(df["error_gaussian_pct"], bins=20, alpha=0.6, label="Gaussian error (%)")
    ax4.hist(df["error_boa_pct"], bins=20, alpha=0.6, label="BoA factor error (%)")
